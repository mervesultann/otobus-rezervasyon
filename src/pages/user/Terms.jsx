        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Seferium, bu koşulları önceden haber vermeksizin değiştirme hakkını saklı tutar.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">2. Hizmet Kullanımı</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>Hizmetlerimizi kullanmak için 18 yaşından büyük olmalısınız</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">3. Bilet İşlemleri</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Bilet satın alma ve iptal işlemleri aşağıdaki kurallara tabidir:
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>Bilet iptalleri sefer saatinden en az 3 saat önce yapılmalıdır</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">4. Ödeme ve İade</h2>
            <p className="text-gray-600 leading-relaxed">
              Tüm ödemeler güvenli ödeme sistemleri üzerinden yapılır. İade işlemleri 
              ilgili banka ve kredi kartı kurallarına tabidir.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">5. Fikri Mülkiyet</h2>
            <p className="text-gray-600 leading-relaxed">
              Site içeriğindeki tüm metinler, görseller, logolar ve diğer materyaller 
              Seferium'un fikri mülkiyetidir ve izinsiz kullanılamaz.
            </p>
          </section>
