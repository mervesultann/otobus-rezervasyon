        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Seferbul olarak kişisel verilerinizin güvenliği konusunda azami
              hassasiyet göstermekteyiz. Kişisel verileriniz 6698 sayılı Kişisel
              Verilerin Korunması Kanunu kapsamında işlenmekte ve
              saklanmaktadır.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Hizmetlerimizi kullanırken aşağıdaki bilgiler tarafımızca
              toplanabilir:
            </p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 mt-4">
              <li>
                Bilet rezervasyonu ve satın alma işlemlerinin gerçekleştirilmesi
              </li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              güvenlik önlemleri kullanılmaktadır. SSL şifreleme, güvenlik
              duvarları ve düzenli güvenlik denetimleri ile verileriniz koruma
              altındadır.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Web sitemizde çerezler kullanılmaktadır. Bu çerezler, size daha
              iyi bir kullanıcı deneyimi sunmak ve hizmetlerimizi geliştirmek
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Gizlilik politikamız hakkında sorularınız için aşağıdaki
              kanallardan bize ulaşabilirsiniz:
            </p>
            <div className="mt-4 text-gray-600">
              <p>Email: privacy@seferbul.com</p>
